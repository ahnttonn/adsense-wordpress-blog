...
require_pattern "$functions_file" 'YOLKMEET_SHOW_AD_PLACEHOLDERS|_yolkmeet_show_ad_placeholders' "keeps manual ad placeholders hidden unless explicitly enabled"
