...
assert_contains "$sitemap_xml" "<lastmod>" "sitemap last modified fields"
...
assert_contains "$post_html" "<meta property=\"article:modified_time\" content=\"" "post modified time"
...
assert_contains "$post_html" "\"dateModified\":\"" "post schema modified date"
...
assert_contains "$post_html" "class=\"source-note\"" "post source note block"
assert_contains "$post_html" "class=\"update-log\"" "post update log block"
